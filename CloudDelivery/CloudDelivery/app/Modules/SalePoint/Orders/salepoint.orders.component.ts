...
export class SalepointOrdersComponent {
    ...
    constructor(private ordersService: SalepointOrdersService, private router: Router, private modalService: ModalFactoryService, private cdr: ChangeDetectorRef) {
