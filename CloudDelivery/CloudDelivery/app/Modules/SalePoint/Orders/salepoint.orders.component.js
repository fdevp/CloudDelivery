...
var SalepointOrdersComponent = /** @class */ (function () {
    function SalepointOrdersComponent(ordersService, router, modalService, cdr) {
    ...
    SalepointOrdersComponent.prototype.initializeOrdersList = function () {
        var _this = this;
    ...
    SalepointOrdersComponent.prototype.orderSelect = function (_a) {
    ...
    SalepointOrdersComponent = __decorate([
        core_1.Component({
            selector: 'app-salepoint-orders',
            templateUrl: './salepoint.orders.component.html'
        }),
        __metadata("design:paramtypes", [SalepointOrdersService_1.SalepointOrdersService, router_1.Router, ModalFactoryService_1.ModalFactoryService, core_1.ChangeDetectorRef])
    ], SalepointOrdersComponent);
    return SalepointOrdersComponent;
}());
exports.SalepointOrdersComponent = SalepointOrdersComponent;
//# sourceMappingURL=salepoint.orders.component.js.map