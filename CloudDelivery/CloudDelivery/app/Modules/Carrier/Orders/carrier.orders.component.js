...
var CarrierOrdersComponent = /** @class */ (function () {
    function CarrierOrdersComponent(ordersService, router, modalService, cdr) {
    ...
    CarrierOrdersComponent.prototype.initializeOrdersList = function () {
        var _this = this;
    ...
    CarrierOrdersComponent.prototype.orderSelect = function (_a) {
    ...
    CarrierOrdersComponent = __decorate([
        core_1.Component({
    ...
    return CarrierOrdersComponent;
}());
exports.CarrierOrdersComponent = CarrierOrdersComponent;
