...
var AdminDashboardComponent = /** @class */ (function () {
    function AdminDashboardComponent(carrierOrdersService, salepointOrdersService, gMapsService, modalService) {
        var _this = this;
        ...
        this.carrierOrdersService.pendingOrdersChanged.subscribe(function (list) {
            _this.pendingOrders = list;
        });
        this.initData();
        this.baseLocation = gMapsService.getBaseLocation();
    }
    AdminDashboardComponent.prototype.initData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        //count
                        this.salepointOrdersService.todayCount().subscribe(function (result) { return _this.todayCount = result; });
                        this.salepointOrdersService.lastWeekCount().subscribe(function (result) { return _this.weekCount = result; });
                        this.salepointOrdersService.lastMonthCount().subscribe(function (result) { return _this.monthCount = result; });
                        //list
                        return [4 /*yield*/, this.carrierOrdersService.pendingList(true).toPromise()];
                    case 1:
                        //list
                        _a.sent();
                        return [2 /*return*/];
    ...
    AdminDashboardComponent.prototype.clickedOrder = function (order) {
